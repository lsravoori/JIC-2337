...
class _AdminStats extends State<AdminStats> {
  ...
  List<Widget> makeChildren() {
    ...
    list.add(Padding(
      ...
      child: Text('Total Accounts: $acctCount'),
    ));
    list.add(Padding(
    ...
    list.add(Padding(
      padding: EdgeInsets.fromLTRB(20, 10, 0, 0),
      child: Text(
          'Other: $otherAccts (${(otherAccts / acctCount).toStringAsFixed(2)}%)'),
    ));
    ...
    list.add(Padding(
      padding: EdgeInsets.fromLTRB(20, 10, 0, 0),
      child: Text(
          'Other: $otherRaceAccts (${(otherRaceAccts / acctCount).toStringAsFixed(2)}%)'),
    ));
    list.add(const Padding(
      padding: EdgeInsets.fromLTRB(20, 10, 0, 0),
      child: Text(''),
